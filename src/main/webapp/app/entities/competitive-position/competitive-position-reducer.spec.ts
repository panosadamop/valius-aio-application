...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './competitive-position.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITIVEPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
