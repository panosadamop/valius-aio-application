...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVELFOUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEVELFOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEVELFOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEVELFOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEVELFOUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEVELFOUR actions', async () => {
      const expectedActions = [
        {
