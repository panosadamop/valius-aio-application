...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './competitor-competitive-position.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITORCOMPETITIVEPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPETITORCOMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPETITORCOMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPETITORCOMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITORCOMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPETITORCOMPETITIVEPOSITION actions', async () => {
      const expectedActions = [
        {
