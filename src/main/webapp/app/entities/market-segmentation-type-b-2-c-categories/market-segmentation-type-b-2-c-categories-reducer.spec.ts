...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './market-segmentation-type-b-2-c-categories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETSEGMENTATIONTYPEB2CCATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARKETSEGMENTATIONTYPEB2CCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARKETSEGMENTATIONTYPEB2CCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARKETSEGMENTATIONTYPEB2CCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARKETSEGMENTATIONTYPEB2CCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARKETSEGMENTATIONTYPEB2CCATEGORIES actions', async () => {
      const expectedActions = [
        {
