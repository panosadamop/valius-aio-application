...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './buying-criteria-weighting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUYINGCRITERIAWEIGHTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
