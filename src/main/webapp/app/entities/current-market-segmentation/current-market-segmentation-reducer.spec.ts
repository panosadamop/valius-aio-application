...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './current-market-segmentation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENTMARKETSEGMENTATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CURRENTMARKETSEGMENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURRENTMARKETSEGMENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURRENTMARKETSEGMENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURRENTMARKETSEGMENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURRENTMARKETSEGMENTATION actions', async () => {
      const expectedActions = [
        {
