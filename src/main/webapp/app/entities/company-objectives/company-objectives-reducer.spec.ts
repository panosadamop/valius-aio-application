...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './company-objectives.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYOBJECTIVES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
