...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-attractiveness-factors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDATTRACTIVENESSFACTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
