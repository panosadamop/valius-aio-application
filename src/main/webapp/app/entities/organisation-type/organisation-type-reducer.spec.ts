...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organisation-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANISATIONTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORGANISATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORGANISATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORGANISATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORGANISATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORGANISATIONTYPE actions', async () => {
      const expectedActions = [
        {
