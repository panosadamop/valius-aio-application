...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONFIDENCELEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONFIDENCELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONFIDENCELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONFIDENCELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONFIDENCELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONFIDENCELEVEL actions', async () => {
      const expectedActions = [
        {
