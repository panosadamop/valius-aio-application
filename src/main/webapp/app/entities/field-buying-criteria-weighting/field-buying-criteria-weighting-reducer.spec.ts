...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-buying-criteria-weighting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDBUYINGCRITERIAWEIGHTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDBUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDBUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDBUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDBUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDBUYINGCRITERIAWEIGHTING actions', async () => {
      const expectedActions = [
        {
