...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './preferred-purchase-channel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDPURCHASECHANNEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
