...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './statistical-error.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATISTICALERROR_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATISTICALERROR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATISTICALERROR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATISTICALERROR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATISTICALERROR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATISTICALERROR actions', async () => {
      const expectedActions = [
        {
