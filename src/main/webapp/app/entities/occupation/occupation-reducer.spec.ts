...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OCCUPATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_OCCUPATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OCCUPATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OCCUPATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OCCUPATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OCCUPATION actions', async () => {
      const expectedActions = [
        {
