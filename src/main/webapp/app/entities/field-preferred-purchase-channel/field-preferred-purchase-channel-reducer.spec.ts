...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-preferred-purchase-channel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDPREFERREDPURCHASECHANNEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDPREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDPREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDPREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDPREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDPREFERREDPURCHASECHANNEL actions', async () => {
      const expectedActions = [
        {
