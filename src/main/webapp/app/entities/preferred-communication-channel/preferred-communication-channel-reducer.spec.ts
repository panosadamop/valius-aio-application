...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './preferred-communication-channel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDCOMMUNICATIONCHANNEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
