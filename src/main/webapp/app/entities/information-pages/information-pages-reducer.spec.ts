...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './information-pages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMATIONPAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_INFORMATIONPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INFORMATIONPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INFORMATIONPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INFORMATIONPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INFORMATIONPAGES actions', async () => {
      const expectedActions = [
        {
