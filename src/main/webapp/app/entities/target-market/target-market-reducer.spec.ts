...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARGETMARKET_LIST actions', async () => {
    ...
    it('dispatches FETCH_TARGETMARKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TARGETMARKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TARGETMARKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TARGETMARKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TARGETMARKET actions', async () => {
      const expectedActions = [
        {
