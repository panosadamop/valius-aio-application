...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-preferred-communication-channel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDPREFERREDCOMMUNICATIONCHANNEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDPREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDPREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDPREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDPREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDPREFERREDCOMMUNICATIONCHANNEL actions', async () => {
      const expectedActions = [
        {
