...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './age-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGEGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGEGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGEGROUP actions', async () => {
      const expectedActions = [
        {
