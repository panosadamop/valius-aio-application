...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POPULATIONSIZE_LIST actions', async () => {
    ...
    it('dispatches FETCH_POPULATIONSIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POPULATIONSIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POPULATIONSIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POPULATIONSIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POPULATIONSIZE actions', async () => {
      const expectedActions = [
        {
