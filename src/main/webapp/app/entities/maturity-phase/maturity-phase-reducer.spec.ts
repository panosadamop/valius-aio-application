...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATURITYPHASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATURITYPHASE actions', async () => {
      const expectedActions = [
        {
