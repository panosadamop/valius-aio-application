...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './industry.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDUSTRY_LIST actions', async () => {
    ...
    it('dispatches FETCH_INDUSTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INDUSTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INDUSTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INDUSTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INDUSTRY actions', async () => {
      const expectedActions = [
        {
