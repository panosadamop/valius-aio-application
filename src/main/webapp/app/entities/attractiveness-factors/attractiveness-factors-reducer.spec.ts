...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './attractiveness-factors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRACTIVENESSFACTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTRACTIVENESSFACTORS actions', async () => {
      const expectedActions = [
        {
