...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './info-page-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFOPAGECATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_INFOPAGECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INFOPAGECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INFOPAGECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INFOPAGECATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INFOPAGECATEGORY actions', async () => {
      const expectedActions = [
        {
