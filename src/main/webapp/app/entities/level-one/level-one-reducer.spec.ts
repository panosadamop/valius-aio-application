...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './level-one.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVELONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEVELONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEVELONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEVELONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEVELONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEVELONE actions', async () => {
      const expectedActions = [
        {
