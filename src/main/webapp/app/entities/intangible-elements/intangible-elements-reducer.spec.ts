...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './intangible-elements.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTANGIBLEELEMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTANGIBLEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTANGIBLEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTANGIBLEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTANGIBLEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTANGIBLEELEMENTS actions', async () => {
      const expectedActions = [
        {
