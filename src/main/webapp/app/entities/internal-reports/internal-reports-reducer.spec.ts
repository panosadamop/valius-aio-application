...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERNALREPORTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
