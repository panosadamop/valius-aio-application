...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './competitive-factors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITIVEFACTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPETITIVEFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPETITIVEFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPETITIVEFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITIVEFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPETITIVEFACTORS actions', async () => {
      const expectedActions = [
        {
