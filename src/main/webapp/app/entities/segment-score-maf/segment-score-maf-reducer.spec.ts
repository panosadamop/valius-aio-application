...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './segment-score-maf.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEGMENTSCOREMAF_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEGMENTSCOREMAF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEGMENTSCOREMAF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEGMENTSCOREMAF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEGMENTSCOREMAF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEGMENTSCOREMAF actions', async () => {
      const expectedActions = [
        {
