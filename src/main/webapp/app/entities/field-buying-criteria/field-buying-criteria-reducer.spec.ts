...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-buying-criteria.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDBUYINGCRITERIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDBUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDBUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDBUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDBUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDBUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
