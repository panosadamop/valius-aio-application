...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PYRAMIDDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PYRAMIDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PYRAMIDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PYRAMIDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PYRAMIDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PYRAMIDDATA actions', async () => {
      const expectedActions = [
        {
