...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './related-service-elements.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELATEDSERVICEELEMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELATEDSERVICEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELATEDSERVICEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELATEDSERVICEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELATEDSERVICEELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELATEDSERVICEELEMENTS actions', async () => {
      const expectedActions = [
        {
