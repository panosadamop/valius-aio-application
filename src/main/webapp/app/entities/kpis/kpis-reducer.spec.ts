...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kpis.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KPIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_KPIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KPIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KPIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KPIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KPIS actions', async () => {
      const expectedActions = [
        {
