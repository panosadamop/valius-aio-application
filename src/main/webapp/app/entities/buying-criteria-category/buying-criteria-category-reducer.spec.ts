...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './buying-criteria-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUYINGCRITERIACATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUYINGCRITERIACATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUYINGCRITERIACATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUYINGCRITERIACATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUYINGCRITERIACATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUYINGCRITERIACATEGORY actions', async () => {
      const expectedActions = [
        {
