...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOOFEMPLOYEES_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOOFEMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOOFEMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOOFEMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOOFEMPLOYEES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOOFEMPLOYEES actions', async () => {
      const expectedActions = [
        {
