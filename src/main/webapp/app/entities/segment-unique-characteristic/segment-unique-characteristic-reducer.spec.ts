...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './segment-unique-characteristic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEGMENTUNIQUECHARACTERISTIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEGMENTUNIQUECHARACTERISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEGMENTUNIQUECHARACTERISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEGMENTUNIQUECHARACTERISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEGMENTUNIQUECHARACTERISTIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEGMENTUNIQUECHARACTERISTIC actions', async () => {
      const expectedActions = [
        {
