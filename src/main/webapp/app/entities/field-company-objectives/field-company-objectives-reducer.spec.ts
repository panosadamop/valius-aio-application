...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './field-company-objectives.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDCOMPANYOBJECTIVES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDCOMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDCOMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDCOMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDCOMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDCOMPANYOBJECTIVES actions', async () => {
      const expectedActions = [
        {
