  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="valiusaioApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="valiusaioApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('valiusaioApp.location.value')}
                id="location-value"
                name="value"
                data-cy="value"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('valiusaioApp.location.description')}
              ...
              />
              <ValidatedField
                label={translate('valiusaioApp.location.language')}
