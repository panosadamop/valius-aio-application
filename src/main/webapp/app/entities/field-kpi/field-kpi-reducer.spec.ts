...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './field-kpi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDKPI_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDKPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDKPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDKPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDKPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDKPI actions', async () => {
      const expectedActions = [
        {
