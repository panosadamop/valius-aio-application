...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().country(DEFAULT_COUNTRY).language(DEFAULT_LANGUAGE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().country(UPDATED_COUNTRY).language(UPDATED_LANGUAGE);
        return country;
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.country(UPDATED_COUNTRY).language(UPDATED_LANGUAGE);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.country(UPDATED_COUNTRY).language(UPDATED_LANGUAGE);
