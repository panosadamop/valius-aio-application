...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUYINGCRITERIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUYINGCRITERIA actions', async () => {
      const expectedActions = [
        {
