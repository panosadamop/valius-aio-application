...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECONOMICFACTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ECONOMICFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ECONOMICFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ECONOMICFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ECONOMICFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ECONOMICFACTORS actions', async () => {
      const expectedActions = [
        {
