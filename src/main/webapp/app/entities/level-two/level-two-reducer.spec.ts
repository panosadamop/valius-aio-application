...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './level-two.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVELTWO_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEVELTWO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEVELTWO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEVELTWO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEVELTWO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEVELTWO actions', async () => {
      const expectedActions = [
        {
