...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './net-promoter-score.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NETPROMOTERSCORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_NETPROMOTERSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NETPROMOTERSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NETPROMOTERSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NETPROMOTERSCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NETPROMOTERSCORE actions', async () => {
      const expectedActions = [
        {
