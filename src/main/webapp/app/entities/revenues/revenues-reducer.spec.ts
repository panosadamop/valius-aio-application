...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './revenues.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVENUES_LIST actions', async () => {
    ...
    it('dispatches FETCH_REVENUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REVENUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REVENUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REVENUES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REVENUES actions', async () => {
      const expectedActions = [
        {
