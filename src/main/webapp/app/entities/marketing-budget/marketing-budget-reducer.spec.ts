...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETINGBUDGET_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARKETINGBUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARKETINGBUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARKETINGBUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARKETINGBUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARKETINGBUDGET actions', async () => {
      const expectedActions = [
        {
