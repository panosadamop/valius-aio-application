...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().value(DEFAULT_VALUE).description(DEFAULT_DESCRIPTION).language(DEFAULT_LANGUAGE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().value(UPDATED_VALUE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getValue()).isEqualTo(DEFAULT_VALUE);
        assertThat(testLocation.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testLocation.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.value(UPDATED_VALUE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getValue()).isEqualTo(UPDATED_VALUE);
        assertThat(testLocation.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testLocation.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.value(UPDATED_VALUE).language(UPDATED_LANGUAGE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.value(UPDATED_VALUE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
