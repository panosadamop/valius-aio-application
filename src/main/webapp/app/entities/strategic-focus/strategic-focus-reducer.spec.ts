...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRATEGICFOCUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_STRATEGICFOCUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRATEGICFOCUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRATEGICFOCUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRATEGICFOCUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRATEGICFOCUS actions', async () => {
      const expectedActions = [
        {
