...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALFACTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALFACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALFACTORS actions', async () => {
      const expectedActions = [
        {
