...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './market-segmentation-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETSEGMENTATIONTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARKETSEGMENTATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARKETSEGMENTATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARKETSEGMENTATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARKETSEGMENTATIONTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARKETSEGMENTATIONTYPE actions', async () => {
      const expectedActions = [
        {
