    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countryDetailsHeading">
          <Translate contentKey="valiusaioApp.country.detail.title">Country</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="country">
              <Translate contentKey="valiusaioApp.country.country">Country</Translate>
            </span>
          </dt>
          <dd>{countryEntity.country}</dd>
          <dt>
            <span id="language">
              <Translate contentKey="valiusaioApp.country.language">Language</Translate>
            </span>
          </dt>
