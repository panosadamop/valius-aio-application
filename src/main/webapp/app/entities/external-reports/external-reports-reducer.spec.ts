...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTERNALREPORTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXTERNALREPORTS actions', async () => {
      const expectedActions = [
        {
