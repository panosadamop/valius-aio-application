...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVELTHREE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEVELTHREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEVELTHREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEVELTHREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEVELTHREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEVELTHREE actions', async () => {
      const expectedActions = [
        {
