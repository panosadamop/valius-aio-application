...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './territory.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERRITORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TERRITORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERRITORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERRITORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERRITORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERRITORY actions', async () => {
      const expectedActions = [
        {
