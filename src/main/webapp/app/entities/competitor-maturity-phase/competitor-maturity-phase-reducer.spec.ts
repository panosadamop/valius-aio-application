...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './competitor-maturity-phase.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITORMATURITYPHASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPETITORMATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPETITORMATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPETITORMATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITORMATURITYPHASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPETITORMATURITYPHASE actions', async () => {
      const expectedActions = [
        {
