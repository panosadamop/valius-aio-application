...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './required-sample-size.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUIREDSAMPLESIZE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUIREDSAMPLESIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUIREDSAMPLESIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUIREDSAMPLESIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUIREDSAMPLESIZE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUIREDSAMPLESIZE actions', async () => {
      const expectedActions = [
        {
