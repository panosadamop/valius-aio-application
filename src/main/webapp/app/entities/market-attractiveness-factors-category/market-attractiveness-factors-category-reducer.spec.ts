...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './market-attractiveness-factors-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETATTRACTIVENESSFACTORSCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARKETATTRACTIVENESSFACTORSCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARKETATTRACTIVENESSFACTORSCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARKETATTRACTIVENESSFACTORSCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARKETATTRACTIVENESSFACTORSCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARKETATTRACTIVENESSFACTORSCATEGORY actions', async () => {
      const expectedActions = [
        {
