  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="valiusaioApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="valiusaioApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('valiusaioApp.country.country')}
                id="country-country"
                name="country"
                data-cy="country"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('valiusaioApp.country.language')}
                id="country-language"
                name="language"
                data-cy="language"
                type="select"
