...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './core-product-elements.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COREPRODUCTELEMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COREPRODUCTELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COREPRODUCTELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COREPRODUCTELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COREPRODUCTELEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COREPRODUCTELEMENTS actions', async () => {
      const expectedActions = [
        {
