...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDPRODUCTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIELDPRODUCTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELDPRODUCTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELDPRODUCTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELDPRODUCTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELDPRODUCTYPE actions', async () => {
      const expectedActions = [
        {
